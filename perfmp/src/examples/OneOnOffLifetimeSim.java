...
class OneOnOffLifetimeSim extends Sim {
	...
	public OneOnOffLifetimeSim(double d) {
...
//		timeouts40 = [10, 15, 20, 25, 30, 35];
		double lifetimerate = 1/13.35;
//		double lifetimeperiod = 21.5;
		
		Exp lifetime = new Exp(lifetimerate);
//		Deterministic lifetime = new Deterministic(lifetimeperiod);
		double L = 3.8;
...
//		System.out.println("Customers at the End of ON - ON-OFF-1: " + on0ff_1.getCustomersEndOn());
		...
		System.out.println("Expired messages: " + Network.completionsExpired);
...
//		Network.responseTime.saveResponseMeasures();
	...
	public static void main(String args[]) {
		new OneOnOffLifetimeSim(1000000);
