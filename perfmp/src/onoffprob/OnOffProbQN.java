...
public class OnOffProbQN extends OnOffRQN {
	public DistributionSampler insertProb;
	

	public OnOffProbQN(String s, Delay d, int n, DistributionSampler on, DistributionSampler off, double insProb, double dur) {
		super(s, d, n, on, off, dur);
		insertProb = new Geometric(insProb);
	}

	public OnOffProbQN(String s, Delay d, int n, Queue q, DistributionSampler on, DistributionSampler off, double insProb, double dur) {
...
//					TODO change this bellow and add special losses for probs
					losses++;
				}
			} else {
				losses++;
