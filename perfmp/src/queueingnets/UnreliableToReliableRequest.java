...
public class UnreliableToReliableRequest extends Sim {
	...
	public UnreliableToReliableRequest(double d) {
		...
		OnOffUQN driver_mdw = new OnOffUQN("DRIVER-MDW", trMsg_app, 1, ONOvrlDriver, OFFOvrlDriver, duration);
		...
		MdwLsesBranch branchDriverMdw =new MdwLsesBranch(new Node[] {sinkDriverMdw, broker_in});
		...
		System.err.println("Lifetime: " + lifetime);
	...
	public void runSimulation(String responseTimesOutputFile, String successRateOutputFile) {
		...
		UnreliableToReliableRequest simulation = new UnreliableToReliableRequest(duration);
